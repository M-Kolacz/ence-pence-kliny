  ...
  var submit_handler =  function (form, wrapper){
    ...
    jQuery.post("php/contacts-process.php", data, function(s_response) {
      ...
      if(s_response.info == 'success'){
        $wrapper.addClass("message message-success").append('<div class="cws_msg_box success-box clearfix"><div class="icon_section"><i class="fa fa-thumbs-up"></i></div><div class="content_section"><div class="msg_box_title">Sukces!</div><div class="msg_box_text">Twoja wiadomość została pomyślnie wysłana.</div></div></div>');
